function [err]= Process_GRF(AnalogSignals,treshold,AnalogFrameRate,VideoFrameRate,outname,Mark,Markers,ParameterGroup);
...
for i=1:nFP    
    ...
    [a,b]=butter(4,25/(AnalogFrameRate*0.5),'low');%40 Hz, low pass filter. 
    F=filtfilt(a,b,F);
...
RHeel = Mark.Data(:,find(strcmp('RANK',Mark.Labels))*3-2:find(strcmp('RANK',Mark.Labels))*3);
LHeel =  Mark.Data(:,find(strcmp('LANK',Mark.Labels))*3-2:find(strcmp('LANK',Mark.Labels))*3);
...
Forces1_filt_proper = Temp; 
Forces2_filt_proper = Temp; 
