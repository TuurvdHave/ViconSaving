function [err]= Process_GRF_TM2(AnalogSignals,treshold,AnalogFrameRate,VideoFrameRate,outname,Mark,Markers,ParameterGroup,RotationMatrix,FP_filter,Footmarker,Frame);
